...
Create and push a version tag, for example v0.1.0, only after reviewing the
...
All releases must identify the real version, not 0.1.0-dev.
...
```sh
graft upgrade-project --version v0.1.0
